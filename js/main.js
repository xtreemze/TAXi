...
// When the taxi stops.
var stopTaxi = function stopping() {
...
// Screen Fade
var blackOut = function Bo() {
  $('.con2').fadeOut(200);
};
// FadeIn
var showTime = function Sho() {
  $('.con2').fadeIn(300);
};
// DEAD STATE
var message = '<span class=\'black\'>Day ' + day + '</span><br><span style=\'font-size:20px\'><br><br><br>Food for ' + food + ' days. <span class=\'red\'>You died!</span><span>';
var taxiDie = function Die() {
  $('.transaction').html(message).delay(20).fadeIn().delay(8000).fadeOut();
};
// END GUI
// GAME LOOP WILL STOP WHEN FALSE
var loop = function looping() {
...
// GAME TIME FUNCTIONS
var nextDay = function passTime(days) {
...
// Loop
var addMinutes = function timePlus(minutesAdd) {
...
var passengerClick = function () {
  ...
  var dist2cab = parseInt(parseInt($(this).css('right'), 10) * 1.1 - 50, 10);
